        ...
        <div class="content-wrapper">
            ...
            <div class="row ">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Siparişi güncelle</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control product_id" name="product_id" required>
                                                ...
                                                @foreach ($product as $product)
                                                    <option @if($orders->product_id == $product->id) selected @endif value="{{$product->id}}">{{$product->product_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="" >Miktar</label>
                                            <input  class="form-control" name="qty" value="{{$orders->qty}}required="" placeholder="Ürün miktarını giriniz" >
                                        </div>
                                        <div class="form-group">
                                            <label for="" >indirim</label>
                                            <input  class="form-control" name="Dis" value="{{$orders->Dis}}required="" placeholder="Ürün indirimini giriniz" >
                                        </div>
                                        <div class="form-group">
